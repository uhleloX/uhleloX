					...
					<div class="col resizable" id="resizable_1">
						...
						if ( isset( $this->item )
							...
							<div class="d-flex justify-content-end align-items-center">
								<a href="<?php echo $this->link; ?>" target="_blank" rel="noopener" class="text-decoration-none text-success pt-3">View <?php echo ucfirst( rtrim( X_Sanitize::out_html( $this->type ), 's' ) ); ?> <span class="bi bi-box-arrow-up-right"></span></a>
							</div>
							<?php
						}
						?>
